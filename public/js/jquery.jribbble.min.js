...
jQuery(window).load(function(){ish.deactivate_site_preloader(),ish.deactivate_portfolio_preloader(),jQuery(window).resize()}),jQuery(window).bind("beforeunload",function(){ish.activate_site_preloader()});
